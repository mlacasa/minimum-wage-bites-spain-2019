# Replication code for the OBES submission
...
The paper is submitted to the **Oxford Bulletin of Economics and Statistics
(OBES, Wiley)**. The repository is prepared as the public replication package
for the submitted version. It will be made public, completed with the final
paper citation, and updated with the published article DOI or final journal
location once the paper is published, in OBES or elsewhere.
...
This repository is aligned with the submitted OBES manuscript and will be
